...
class SplashPage extends StatefulWidget {
  ...
  SplashPage({Key? key, required this.isBidding, required this.androidId, required this.iosId}) : super(key: key);
      ...
      body: Container(
        child: FlutterTencentad.splashAdView(
          ...
          callBack: FlutterTencentadSplashCallBack(onShow: () {
            ...
            _bidding.biddingResult(FlutterTencentBiddingResult().fail(winPrice, FlutterTencentAdBiddingLossReason.TIME_OUT, FlutterTencentAdADNID.othoerADN));
            Navigator.pop(context);
